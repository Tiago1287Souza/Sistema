...
public class ConsultarAluno extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tabelaaluno.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
        tabelaaluno.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "NOME", "IDADE", "CPF", "RG", "ENDERECO","BAIRRO","EMAIL"
            }
        ));
    ...
    private void buscar() throws SQLException {
        ...
        ArrayList<alunos> alunos = AlunoDao.selectAll();

        for (int num = 0; num < alunos.size(); num++) {

            model.addRow(new Object[]{
                alunos.get(num).getNome(),
                alunos.get(num).getIdade(),
                alunos.get(num).getCpf(),
                alunos.get(num).getRg(),
                alunos.get(num).getEndereco(),
                alunos.get(num).getBairro(),
                alunos.get(num).getEmail()
